...
namespace Opah.TransactionService.Infrastructure.Tests
{
    public class KeycloakRolesTransformationTests
    {
        ...
        [Fact]
        public async Task TransformAsync_Should_Return_Principal_When_RealmAccess_Is_Missing()
        {
            // Arrange
        ...
        [Fact]
        public async Task TransformAsync_Should_Return_Principal_When_RealmAccess_Is_Empty()
        {
            // Arrange
        ...
        public async Task TransformAsync_Should_Add_Roles_From_RealmAccess()
        {
            ...
            // Assert
            var roles = result.FindAll(ClaimTypes.Role).Select(r => r.Value).ToList();
